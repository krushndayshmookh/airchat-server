...
router.post(
  "/organization/create",
  organizationController.organization_create_post
);
...
router.post(
  ...
  organizationController.organization_delete_post
);
...
router.get(
  ...
  organizationController.organizations_delete_all_get
);

// GET request for all root organizations.
router.get(
  "/organizations/root",
  organizationController.organizations_root_get
);

// GET request for all suborganizations.
router.get(
  "/organizations/:id",
  organizationController.organization_suborgs_get
);

// GET request for organization members.
router.get(
  "/organization/:id/members",
  organizationController.organization_members_get
);
...
router.post(
  "/conversation/create",
  conversationController.conversation_create_post
);
...
router.get(
  ...
  conversationController.conversations_delete_all_get
);

// GET request for deleting one conversation.
router.post(
  "/conversation/:id/delete",
  conversationController.conversation_delete_post
);

// POST request for joining conversation.
router.post(
  "/conversation/:id/join",
  conversationController.conversation_join_post
);
